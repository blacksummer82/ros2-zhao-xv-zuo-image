...
![](/https://gitee.com/blacksummer-31/ros2--zhao-xu-zuo---image/raw/master/img/2.2.1案例1演示.gif)

**需求2：**编写话题通信实现，发布方以某个频率发布自定义接口消息，订阅方订阅消息，并输出在终端。

![](/https://gitee.com/blacksummer-31/ros2--zhao-xu-zuo---image/raw/master/img/2.2.1案例2演示.gif)
