...
![](/https://gitee.com/blacksummer-31/ros2--zhao-xu-zuo---image/raw/master/img/1.5.2命令行工具.gif)

**示例2：**使用rqt在turtlesim\_node中生成一只新乌龟。

![](/https://gitee.com/blacksummer-31/ros2--zhao-xu-zuo---image/raw/master/img/3.7.2RQT工具箱service.gif)
...
![](/https://gitee.com/blacksummer-31/ros2--zhao-xu-zuo---image/raw/master/img/1.5.2launch使用.gif)
...
![](/https://gitee.com/blacksummer-31/ros2--zhao-xu-zuo---image/raw/master/img/5.3.1案例演示1.gif)

**示例2：**使用turtlesim\_node模拟多机器人编队。

![](/https://gitee.com/blacksummer-31/ros2--zhao-xu-zuo---image/raw/master/img/5.6.4乌龟护航案例.gif)
...
![](/https://gitee.com/blacksummer-31/ros2--zhao-xu-zuo---image/raw/master/img/6.2rviz2基本使用示例.png)

**示例2：**显示机器人模型。

![](/https://gitee.com/blacksummer-31/ros2--zhao-xu-zuo---image/raw/master/img/6.5.3xacro_练习.gif)
