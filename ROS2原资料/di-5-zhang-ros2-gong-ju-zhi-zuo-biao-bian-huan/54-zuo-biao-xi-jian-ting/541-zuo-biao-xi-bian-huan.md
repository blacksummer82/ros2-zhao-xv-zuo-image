...
![](/https://gitee.com/blacksummer-31/ros2--zhao-xu-zuo---image/raw/master/img/5.4.1案例演示1.gif)

**案例2：**在**5.3 坐标变换广播**中发布了laser相对于base\_link的坐标系关系且发布了laser坐标系下的障碍物的坐标点数据，请求解base\_link坐标系下该障碍物的坐标。

![](/https://gitee.com/blacksummer-31/ros2--zhao-xu-zuo---image/raw/master/img/5.4.1案例演示2.gif)
